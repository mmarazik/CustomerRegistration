...
class DatabaseHelper {
  ...
  static final columnPassportNumber = 'passport_num';
  static final columnEmail = 'email';
  static final columnImagePath = 'image_path';
  static final columnDeviceName = 'device_name';
  ...
  Future _onCreate(Database db, int version) async {
    await db.execute('''
          CREATE TABLE $table (
            ...
            $columnPassportNumber TEXT, 
            $columnEmail TEXT,
            $columnImagePath TEXT NOT NULL,
            $columnDeviceName TEXT NOT NULL,
            $columnLng REAL default NULL,
            $columnLat REAL default NULL
          )
          ''');
  }
